...
//            btnUpdate.setVisible(true);
    ...
    public void onClickAdd(ActionEvent actionEvent) {
        ...
        try {
            ...
            mailService.sendMail(
                    Map.of(
                            email,
                            String.format("Xin chào <b>%s</b>," +
                                    " tài khoản của bạn được tạo thành công với tên tài khoản là <b>%s</b> và mật khẩu <b>%s</b>," +
                                    " hãy thay đổi sau khi đăng nhập", readerName, username, password)
                    ),
    ...
    public void onClickDelete(ActionEvent actionEvent) {
        ...
        if (selectedReader.isPresent() && AlertUtil.showConfirmation("Bạn có chắc chắn muốn xóa người đọc này không?")) {
    ...
    public void onClickUpdate(ActionEvent actionEvent) {
        ...
        if (selectedReader.isEmpty()) {
            AlertUtil.showAlert(Alert.AlertType.ERROR, "Lỗi", null, "Hãy chọn độc giả cần cập nhật");
            return;
        }
    ...
    private boolean isNull(Object... o) {
        for (Object obj : o) {
            if (obj == null || obj.toString().isEmpty()) {
                AlertUtil.showAlert(Alert.AlertType.ERROR, "Lỗi", null, "Hãy điền tất cả các trường!");
                return true;
            }
        }
        return false;
