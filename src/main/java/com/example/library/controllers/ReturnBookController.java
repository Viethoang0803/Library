...
public class ReturnBookController {
    ...
    public void onClickOk(ActionEvent actionEvent) {
        ...
        if (bookId.isEmpty() || readerId.isEmpty()) {
            AlertUtil.showAlert(Alert.AlertType.ERROR, "Lỗi!", null, "Hãy điền toàn bộ trường thông tin");
            return;
        }
        ...
        AlertUtil.showAlert(Alert.AlertType.INFORMATION, "Thông báo", null, "Trả sách thành công");
